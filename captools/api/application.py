...
class CallbackHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(
            b"<html><head><title>Captricity API Token</title></head><body>%s</body></html>"
            % body.encode()
        )
...
class ThirdPartyApplication(object):
    def __init__(
        ...
        third_party_id,
        secret_key,
        endpoint="https://shreddr.captricity.com",
        port=None,
    ):
    ...
    def get_account_access_request_url(self, return_url):
        ...
        params["signature"] = generate_request_access_signature(params, self.secret_key)
